...
const std::string MODEL_PATH = "Models/girl.obj";
const std::string TEXTURE_PATH = "Textures/girl.png";
...
private:
    ...
    void updateUniformBuffer(uint32_t currentImage) {
        ...
        ubo.view = glm::lookAt(glm::vec3(5.0f, 5.0f, 5.0f), glm::vec3(0.0f, 0.0f, 2.0f), glm::vec3(0.0f, 0.0f, 1.0f));
